...
import rian2 from "@/app/assets/rian_about.jpeg";
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-t from-[#6a87c1] via-[#7da2b3] to-[#f3f2f2]">
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row items-center">
            ...
            <h1 className="font-extrabold text-8xl flex justify-between bg-clip-text text-transparent bg-gradient-to-r from-[#384B70] via-[#507687] to-[#767573] mb-6">About Us</h1>
             <h1 className="text-left font-bold text-5xl sm:text-5xl md:text-7xl lg:text-5xl transition-transform duration-300 transform hover:scale-105 bg-clip-text text-transparent 
              ...
              <p className="text-left text-lg sm:text-xl md:text-1xl font-bold mt-2 transition-transform duration-300 transform hover:scale-105 text-[#16573f] mb-2">
                My name is Rian Isramdani, I come from Bandung. I am 21 years old, I am currently studying at Widyatama Bandung. I previously worked at Komatsu Indonesia.
                as a welder production operator for 2 years. Previously I studied fullstack web programming at <span className="text-[#cd3833]">Purwadhika Bandung</span>.
            ...
            <div className="md:w-1/2 flex justify-center">
              <Image src={rian2} alt="rian" width={350} height={300} className="rounded-sm transition-transform duration-300 transform hover:scale-105" />
            </div>
          </div>
        </div>
      </div>
